...
if(!isset($config['cf_member_img_size'])) {
    ...
    $sql = " update {$g5['config_table']} set cf_member_img_size = 50000, cf_member_img_width = 400, cf_member_img_height = 400 ";
    sql_query($sql, false);

    $config['cf_member_img_size'] = 50000;
    $config['cf_member_img_width'] = 400;
    $config['cf_member_img_height'] = 400;
}
...
<section id="anc_cf_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="cf_customer">고객센터 안내<strong class="sound_only">필수</strong></label></th>
            <td>
            <textarea name="cf_customer" id="cf_customer" cols="30" rows="10"><?php echo $config['cf_customer']; ?></textarea>
            </td>
        </tr>
        <tr>
