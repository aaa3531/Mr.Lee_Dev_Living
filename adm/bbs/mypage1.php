...
// }
$sql_common .= " and b.gr_id = 'community' ";
...
$write_pages = get_pagingUncomp(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $pagek, $total_page, "?gr_id=$gr_id&amp;view=$view&amp;mb_id=$mb_id&amp;pagek=");


include_once($new_skin_path.'/new.skin1.php');
