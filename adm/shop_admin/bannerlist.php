...
<div class="local_ov01 local_ov">
    ...
    <select name="bn_position" id="bn_position">
        ...
        <option value="스토어메인"<?php echo get_selected($bn_position, '스토어메인', true); ?>>스토어메인</option>
        <option value="스토어종류별"<?php echo get_selected($bn_position, '스토어종류별', true); ?>>스토어종류별</option>
        <option value="스토어업종별"<?php echo get_selected($bn_position, '스토어업종별', true); ?>>스토어업종별</option>
        <option value="스토어베스트"<?php echo get_selected($bn_position, '스토어베스트', true); ?>>스토어베스트</option>
        <option value="스토어최신"<?php echo get_selected($bn_position, '스토어최신', true); ?>>스토어최신</option>
        <option value="렌탈메인"<?php echo get_selected($bn_position, '렌탈메인', true); ?>>렌탈메인</option>
        <option value="렌탈종류별"<?php echo get_selected($bn_position, '렌탈종류별', true); ?>>렌탈종류별</option>
        <option value="렌탈업종별"<?php echo get_selected($bn_position, '렌탈업종별', true); ?>>렌탈업종별</option>
        <option value="렌탈베스트"<?php echo get_selected($bn_position, '렌탈베스트', true); ?>>렌탈베스트</option>
        <option value="렌탈최신"<?php echo get_selected($bn_position, '렌탈최신', true); ?>>렌탈최신</option>
    </select>
