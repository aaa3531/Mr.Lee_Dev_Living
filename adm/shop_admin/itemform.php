...
?>
<script src="<?php echo G5_URL; ?>/js/jquery.steps.js"></script>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <label for="it_type1">스토어종류별 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_hit.gif" alt=""></label>
                <input type="checkbox" name="it_type2" value="1" <?php echo ($it['it_type2'] ? "checked" : ""); ?> id="it_type2">
                <label for="it_type2">스토어업종별 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_rec.gif" alt=""></label>
                <input type="checkbox" name="it_type3" value="1" <?php echo ($it['it_type3'] ? "checked" : ""); ?> id="it_type3">
                <label for="it_type3">렌탈종류별 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_new.gif" alt=""></label>
                <input type="checkbox" name="it_type4" value="1" <?php echo ($it['it_type4'] ? "checked" : ""); ?> id="it_type4">
                <label for="it_type4">렌탈업종별 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_best.gif" alt=""></label>
                <input type="checkbox" name="it_type5" value="1" <?php echo ($it['it_type5'] ? "checked" : ""); ?> id="it_type5">
                <label for="it_type5">스토어메인 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_discount.gif" alt=""></label>
                <input type="checkbox" name="it_type6" value="1" <?php echo ($it['it_type6'] ? "checked" : ""); ?> id="it_type6">
                <label for="it_type6">렌탈메인 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_discount.gif" alt=""></label>
                 <input type="checkbox" name="it_type7" value="1" <?php echo ($it['it_type7'] ? "checked" : ""); ?> id="it_type7">
                <label for="it_type7">스토어 홈<img src="<?php echo G5_SHOP_URL; ?>/img/icon_discount.gif" alt=""></label>
                 <input type="checkbox" name="it_type8" value="1" <?php echo ($it['it_type8'] ? "checked" : ""); ?> id="it_type8">
                <label for="it_type8">렌탈 홈 <img src="<?php echo G5_SHOP_URL; ?>/img/icon_discount.gif" alt=""></label>
            </td>
            <td class="td_grpset">
                ...
                $(function() {
                    ...
                    $("#option_table_create").click(function() {
                        ...
                        $.post(
                            ...
                            { it_id: it_id, w: "<?php echo $w; ?>", opt1_subject: opt1_subject, opt2_subject: opt2_subject, opt3_subject: opt3_subject, opt4_subject: opt4_subject, opt1: opt1, opt2: opt2, opt3: opt3, opt4: opt4 },
                            function(data) {
