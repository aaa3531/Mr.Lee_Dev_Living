    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="de_mobile_type7_list_mod" value="<?php echo $default['de_mobile_type7_list_mod']; ?>" id="de_mobile_type7_list_mod" class="frm_input" size="3">
                <label for="de_mobile_type7_list_row">출력할 줄 수</label>
                <input type="text" name="de_mobile_type7_list_row" value="<?php echo $default['de_mobile_type7_list_row']; ?>" id="de_mobile_type7_list_row" class="frm_input" size="3">
                <label for="de_mobile_type7_img_width">이미지 폭</label>
                <input type="text" name="de_mobile_type7_img_width" value="<?php echo $default['de_mobile_type7_img_width']; ?>" id="de_mobile_type7_img_width" class="frm_input" size="3">
                <label for="de_mobile_type7_img_height">이미지 높이</label>
                <input type="text" name="de_mobile_type7_img_height" value="<?php echo $default['de_mobile_type7_img_height']; ?>" id="de_mobile_type7_img_height" class="frm_input" size="3">
            </td>
        </tr>
        <tr>
            <th scope="row">렌탈홈출력</th>
            <td>
                ...
                <input type="text" name="de_mobile_type8_list_mod" value="<?php echo $default['de_mobile_type8_list_mod']; ?>" id="de_mobile_type8_list_mod" class="frm_input" size="3">
                <label for="de_mobile_type8_list_row">출력할 줄 수</label>
                <input type="text" name="de_mobile_type8_list_row" value="<?php echo $default['de_mobile_type8_list_row']; ?>" id="de_mobile_type8_list_row" class="frm_input" size="3">
                <label for="de_mobile_type8_img_width">이미지 폭</label>
                <input type="text" name="de_mobile_type8_img_width" value="<?php echo $default['de_mobile_type8_img_width']; ?>" id="de_mobile_type8_img_width" class="frm_input" size="3">
                <label for="de_mobile_type8_img_height">이미지 높이</label>
                <input type="text" name="de_mobile_type8_img_height" value="<?php echo $default['de_mobile_type8_img_height']; ?>" id="de_mobile_type8_img_height" class="frm_input" size="3">
            </td>
        </tr>
        </tbody>
        </table>
