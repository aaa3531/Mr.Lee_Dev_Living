...
$check_skin_keys = array('de_type1_list_skin', 'de_type2_list_skin', 'de_type3_list_skin', 'de_type4_list_skin', 'de_type5_list_skin', 'de_type6_list_skin','de_mobile_type1_list_skin', 'de_mobile_type2_list_skin', 'de_mobile_type3_list_skin', 'de_mobile_type4_list_skin', 'de_mobile_type5_list_skin','de_mobile_type6_list_skin', 'de_rel_list_skin', 'de_mobile_rel_list_skin', 'de_search_list_skin', 'de_mobile_search_list_skin', 'de_listtype_list_skin', 'de_mobile_listtype_list_skin');
...
'de_type6_list_mod',            //할인상품출력 이미지 수
'de_type6_list_row',            //할인상품출력 줄수
'de_type6_img_width',           //할인상품출력 이미지 폭
'de_type6_img_height', 
...
'de_mobile_type6_list_mod',     //모바일 할인상품출력 이미지수
'de_mobile_type6_list_row',     //모바일 할인상품출력 줄수
'de_mobile_type6_img_width',    //모바일 할인상품출력 이미지 폭
'de_mobile_type6_img_height',   //모바일 할인상품출력 이미지 높이
'de_bank_use',                  //무통장입금사용
...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$de_admin_company_owner}',
                ...
                de_type7_list_use             = '{$de_type7_list_use}',
                de_type7_list_skin            = '{$de_type7_list_skin}',
                de_type7_list_mod             = '{$de_type7_list_mod}',
                de_type7_list_row             = '{$de_type7_list_row}',
                de_type7_img_width            = '{$de_type7_img_width}',
                de_type7_img_height           = '{$de_type7_img_height}',
                de_type8_list_use             = '{$de_type8_list_use}',
                de_type8_list_skin            = '{$de_type8_list_skin}',
                de_type8_list_mod             = '{$de_type8_list_mod}',
                de_type8_list_row             = '{$de_type8_list_row}',
                de_type8_img_width            = '{$de_type8_img_width}',
                de_type8_img_height           = '{$de_type8_img_height}',
                ...
                de_mobile_type6_list_row      = '{$de_mobile_type6_list_row}',
                de_mobile_type6_img_width     = '{$de_mobile_type6_img_width}',
                de_mobile_type6_img_height    = '{$de_mobile_type6_img_height}',
                de_mobile_type7_list_use      = '{$de_mobile_type7_list_use}',
                de_mobile_type7_list_skin     = '{$de_mobile_type7_list_skin}',
                de_mobile_type7_list_mod      = '{$de_mobile_type7_list_mod}',
                de_mobile_type7_list_row      = '{$de_mobile_type7_list_row}',
                de_mobile_type7_img_width     = '{$de_mobile_type7_img_width}',
                de_mobile_type7_img_height    = '{$de_mobile_type7_img_height}',
                de_mobile_type8_list_use      = '{$de_mobile_type8_list_use}',
                de_mobile_type8_list_skin     = '{$de_mobile_type8_list_skin}',
                de_mobile_type8_list_mod      = '{$de_mobile_type8_list_mod}',
                de_mobile_type8_list_row      = '{$de_mobile_type8_list_row}',
                de_mobile_type8_img_width     = '{$de_mobile_type8_img_width}',
                de_mobile_type8_img_height    = '{$de_mobile_type8_img_height}',
