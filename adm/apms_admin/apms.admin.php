...
switch($ap) {
	...
	case 'returned'	: $sub_menu = '888007'; $g5['title'] = '반품관리'; break;
...
//Check
$chk_ap = array('install', 'update', 'thema', 'menu', 'bpage', 'npage', 'shingo', 'uselog', 'basic', 'plist', 'pform', 'mlist', 'returned', 'delivery', 'sendcost', 'payment');
...
if($mode) {
	...
	$chk_mode = array('install', 'thema', 'menu', 'bpage', 'npage', 'shingo', 'uselog', 'basic', 'plist', 'pform', 'mlist', 'returned', 'delivery', 'sendcost', 'payment');
	...
	switch($mode) {
		...
		case 'returned'	: $ap_file = './apms.returned.php'; break;
