...
<div class="local_ov01 local_ov">
    <span class="btn_ov01"><span class="ov_txt">수익발생 마케터</span><span class="ov_num"> <?php echo number_format($total_count) ?>명</span></span>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
		...
		<td class="td_num_right"><?php echo number_format($row['sale']);?>원</td>
		<td class="td_num_right"><?php echo number_format($row['cnt']);?>건</td>
		<td class="td_num_right"><?php echo number_format($row['profit']);?>원</td>
		<td class="td_num_right"><?php echo number_format($row['benefit']);?>원</td>
		<td class="td_num_right"><b><?php echo number_format($row['revenue']);?>원</b></td>
		<td class="td_num_right"><?php echo $rate;?>%</td>
    </tr>
	<?php
    }
    if ($i == 0)
