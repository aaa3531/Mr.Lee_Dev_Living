...
if(IS_YC) {
	...
	sql_query(" ALTER TABLE `{$g5['g5_shop_default_table']}`
					...
					ADD `pt_comment_limit` int(11) NOT NULL DEFAULT '0',
	...
	sql_query(" ALTER TABLE `{$g5['g5_shop_cart_table']}`
					...
					ADD `pt_id` varchar(255) NOT NULL DEFAULT '',
	...
	// 장바구니 테이블에 필드 추가 4
	sql_query(" ALTER TABLE `{$g5['g5_shop_cart_table']}` ADD `pt_receive` varchar(255) NOT NULL DEFAULT '' AFTER `pt_receive_num` ", false);
	sql_query(" ALTER TABLE `{$g5['g5_shop_cart_table']}` ADD `pt_receive_num` varchar(255) NOT NULL DEFAULT '' AFTER `pt_receive` ", false);
	...
	sql_query(" ALTER TABLE `{$g5['g5_shop_item_table']}`
					...
					ADD `pt_thumb` varchar(255) NOT NULL DEFAULT '',
					ADD `pt_link1` varchar(255) NOT NULL DEFAULT '',
					ADD `pt_link2` varchar(255) NOT NULL DEFAULT '',
					ADD `pt_map` varchar(255) NOT NULL DEFAULT '',
					ADD `pt_id` varchar(255) NOT NULL DEFAULT '',
					ADD `pt_it` tinyint(4) NOT NULL DEFAULT '1',
					ADD `pt_ccl` tinyint(4) NOT NULL DEFAULT '0',
					ADD `pt_img` tinyint(4) NOT NULL DEFAULT '0',
					ADD `pt_file` tinyint(4) NOT NULL DEFAULT '0',
					ADD `pt_main` tinyint(4) NOT NULL DEFAULT '0',
					ADD `pt_point` tinyint(4) NOT NULL DEFAULT '0',
					...
					ADD `pt_qa` int(11) NOT NULL DEFAULT '0',
	...
	sql_query(" ALTER TABLE `{$g5['g5_shop_item_use_table']}`
					...
					ADD `pt_id` varchar(255) NOT NULL DEFAULT '' ", false);
	...
	sql_query(" ALTER TABLE `{$g5['g5_shop_order_table']}`
					ADD `pt_case` varchar(255) NOT NULL DEFAULT '',
					ADD `pt_price` varchar(255) NOT NULL DEFAULT '',
					ADD `pt_memo` varchar(255) NOT NULL DEFAULT '' ", false);
...
sql_query(" ALTER TABLE `{$g5['board_table']}`
				...
				ADD `as_new` tinyint(4) NOT NULL DEFAULT '0',
				...
				ADD `as_rev_cmt` tinyint(4) NOT NULL DEFAULT '0',
				ADD `as_best_cmt` tinyint(4) NOT NULL DEFAULT '0',
				ADD `as_rank_cmt` tinyint(4) NOT NULL DEFAULT '3',
				...
				ADD `as_editor` varchar(255) NOT NULL DEFAULT '',
				ADD `as_mobile_editor` varchar(255) NOT NULL DEFAULT '',
...
sql_query(" ALTER TABLE `{$g5['board_table']}` ADD `as_resize` int(11) NOT NULL DEFAULT '0' AFTER `as_rank_cmt` ", false);
...
sql_query(" ALTER TABLE `{$g5['member_table']}`
				...
				ADD `as_join` int(11) NOT NULL DEFAULT '0',
