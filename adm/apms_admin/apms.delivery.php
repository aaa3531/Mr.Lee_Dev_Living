...
<div class="local_ov01 local_ov">
    <span class="btn_ov01"><span class="ov_txt">주문내역</span><span class="ov_num"> <?php echo number_format($total_count) ?>건</span></span>
</div>

<form name="frm_delivery" class="local_sch01 local_sch" method="get">
...
<div class="sch_last">
	...
	<input type="text" name="fr_date" value="<?php echo $fr_date; ?>" id="fr_date" required class="frm_input" size="10" maxlength="10" readonly> 일
	~
	<input type="text" name="to_date" value="<?php echo $to_date; ?>" id="to_date" required class="frm_input" size="10" maxlength="10" readonly> 일
	&nbsp;
