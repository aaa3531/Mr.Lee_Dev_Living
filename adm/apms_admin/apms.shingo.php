...
<div class="local_ov01 local_ov">
    <?php if ($page > 1) {?><a href="<?php echo $_SERVER['PHP_SELF']; ?>" class="ov_listall">처음으로</a> | <?php } ?>
    <span class="btn_ov01"><span class="ov_txt">잠금현황</span><span class="ov_num"> <?php echo number_format($total_count) ?>건</span></span>
</div>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <?php for ($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$content = apms_cut_text($row2['wr_content'], 100);
	?>
    <tr>
        ...
        <td class="td_mng td_mng_m">
            <a href="./apms.admin.php?ap=shingo&amp;mode=shingo&amp;id=<?php echo $row['id']; ?>&amp;page=<?php echo $page;?>" class="btn btn_03 apms-confirm">
				해제
			</a>
        </td>
    </tr>
