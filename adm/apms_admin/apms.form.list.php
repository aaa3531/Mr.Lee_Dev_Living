...
<div id="formlist" class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <td class="td_mng">
            <a href="./apms.form.list.php?pi_id=<?php echo $row['pi_id'];?>&act=del" class="btn_del_form btn btn_02">삭제</a>
        </td>
    </tr>
    <?php
    }
...
<div class="btn_fixed_top">
    <a href="<?php echo G5_ADMIN_URL;?>/shop_admin/categorylist.php" class="btn btn_02">분류관리</a>
	<input type="submit" name="act_button" value="일괄저장" class="btn_submit btn">
</div>
</form>
