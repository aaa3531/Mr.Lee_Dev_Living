...
// if ($gr_id) {
//     $sql_common .= " and b.gr_id = 'portfolio' ";
// }
$sql_common .= " and a.bo_table = 'fur_content' ";
$sql_common .= " and b.bo_category_list = '퍼닝유튜브' ";
...
$write_pages = get_pagingcomp(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $pageC, $total_page, "?gr_id=$gr_id&amp;view=$view&amp;mb_id=$mb_id&amp;pageC=");


include_once($new_skin_path.'/new.skin2.php');
