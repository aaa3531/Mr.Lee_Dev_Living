...
<div class="well" style="padding-bottom:3px;">
	<form class="form" role="form" name="frm_searchorder" method="get">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				...
				<div class="form-group input-group input-group-sm">
					<span class="input-group-addon">시작날짜</span>
			...
			<div class="col-sm-2">
				...
				<div class="form-group input-group input-group-sm">
					<span class="input-group-addon">종료날짜</span>
			...
			<div class="col-sm-3">
				...
				<div class="form-group input-group input-group-sm">
			        ...
			        <input type="text" name="stx" value="<?php echo $stx; ?>" id="stx" class="form-control input-sm" placeholder="주문자 입력">
				</div>
			</div>
			<div class="col-sm-3">
				<div class="form-group">
...
<div class="table-responsive">
	<table class="table tbl bg-white delivery-table">
	<tbody>
	<tr class="bg-black">
	...
	?>
			<tr class="od-tr">
               <?php if($j == 0) { ?>
				...
				<td class="text-center">
					<p><?php echo $list[$i]['od_cart_price'];?></p>
				</td>
				<td class="text-center">
				...
				<?php if($list[$i]['it'][$j]['ct_status'] == '주문'){ ?>
               ...
               <td class="text-center">
				...
				<td class="text-center">
					<select name="ct_status[<?php echo $z; ?>]" class="form-control input-sm">
						<option value="입금"<?php echo get_selected($list[$i]['it'][$j]['ct_status'],'입금');?>>입금완료</option>
