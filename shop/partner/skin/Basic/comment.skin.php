...
<div class="well" style="padding-bottom:3px;">
	...
	<input type="hidden" name="save_opt" value="<?php echo $opt; ?>">
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="form-group">
					<button type="submit" class="btn btn-primary btn-sm btn-block">보기</button>
				</div>
			</div>
			<div class="col-sm-3">
				<div class="form-group">
					<a href="./?ap=<?php echo $ap;?>" class="btn btn-danger btn-sm btn-block">초기화</a>
				</div>
			</div>
		</div>
	</form>
...
<h3>
	<span>총 등록 댓글</span>: <?php echo number_format($total_count); ?> 건
</h3>
			...
			<div class="media-body">
				...
				<div class="media-it">
					<a href="<?php echo $list[$i]['href'];?>" target="_blank">
						<span class="text-muted"> <?php echo $list[$i]['it_name'];?></span>
					</a>
				</div>
		  </div>
		</div>
