...
switch($ap) {
    ...
    case 'returned'		: $skin_file = 'returned.php'; $chk_access = 1; break;
	case 'list'			: $skin_file = 'itemlist.php'; $chk_access = 1; break;
	case 'editpartner'	: $skin_file = 'editpartner.php'; $chk_access = 1; break;
	case 'editstore'	: $skin_file = 'editstore.php'; $chk_access = 1; break;
	case 'item'			: $skin_file = 'itemform.php'; $chk_access = 1; break;
	case 'itemalarm'	: $skin_file = 'itemalarm.php'; $chk_access = 1; break;
	case 'comment'		: $skin_file = 'comment.php'; $chk_access = 1; break;
	case 'searchorder'	: $skin_file = 'searchorder.php'; $chk_access = 1; break;
	case 'costrev'	    : $skin_file = 'costrev.php'; $chk_access = 1; break;
	...
	case 'faq_part'		: $skin_file = 'faq_part.php'; $chk_access = 1; break;
    case 'viewsale'	    : $skin_file = 'viewsale.php'; $chk_access = 1; break;
