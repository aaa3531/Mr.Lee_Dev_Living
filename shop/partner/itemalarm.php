...
if ($is_auth) {
	$sql_common .= " and (a.pt_id = '' or a.pt_id = '{$mb_id}') and a.it_soldout = '1'";
} else {
	$sql_common .= " and a.pt_id = '{$mb_id}' and a.it_soldout = '1'";
}
$sql_common .= ") ";
...
include_once($skin_path.'/itemalarm.skin.php');
?>
