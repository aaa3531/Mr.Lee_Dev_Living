...
for ($i=0; $row=sql_fetch_array($result); $i++) { 
	...
	// 주문상품
	$sql1 = " select a.od_id, a.ct_status, a.it_id, a.it_name, a.ct_send_cost, a.it_sc_type, a.pt_receive, a.pt_receive_num, b.pt_msg1, b.pt_msg2, b.pt_msg3
...
// 스킨
include_once($skin_path.'/returned.skin.php');
