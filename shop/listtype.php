...
if( isset($sort) && ! in_array($sort, array('it_sum_qty', 'it_price', 'it_use_avg', 'it_use_cnt', 'it_update_time', 'pt_comment', 'it_type1', 'it_type2', 'it_type3', 'it_type4', 'it_type5', 'it_type6')) ){
    $sort='';
}
...
if ($type == 1)      $g5['title'] = '종류별 랭킹';
else if ($type == 2) $g5['title'] = '업종별 랭킹';
else if ($type == 3) $g5['title'] = '종류별 랭킹';
else if ($type == 4) $g5['title'] = '업종별 랭킹';
else if ($type == 5) $g5['title'] = '메인 스토어 상품';
else if ($type == 6) $g5['title'] = '메인 렌탈 상품';
else
    alert('상품유형이 아닙니다.');
