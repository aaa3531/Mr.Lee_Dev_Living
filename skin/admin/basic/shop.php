    ...
    <div id="sidx_stat">
        ...
        <section id="anc_sidx_stock">
            ...
            <div id="sidx_stock" class="tbl_head01 tbl_wrap">
                ...
                <tbody>
                <tr>
                    <td class="td_num2"><a href="<?php echo G5_ADMIN_URL;?>/shop_admin/itemstocklist.php"><?php echo number_format($item_noti); ?></a></td>
                    <td class="td_num2"><a href="<?php echo G5_ADMIN_URL;?>/shop_admin/optionstocklist.php"><?php echo number_format($option_noti); ?></a></td>
...
<div class="sidx sidx_cs">
    ...
    <section id="anc_sidx_qna">
        ...
        <div class="ul_01 ul_wrap">
            <ul>
                ...
                ?>
                <li>
                    <a href="<?php echo G5_ADMIN_URL;?>/shop_admin/itemqaform.php?w=u&amp;iq_id=<?php echo $row['iq_id']; ?>" class="qna_link"><?php echo conv_subject($row['iq_subject'],40); ?></a>
                    <?php echo $name; ?>
                </li>
                <?php
                }
        ...
        <div class="btn_list03 btn_list">
            <a href="<?php echo G5_ADMIN_URL;?>/shop_admin/itemqalist.php?sort1=iq_answer&amp;sort2=asc">상품문의 더보기</a>
        </div>
    </section>
    ...
    <section id="anc_sidx_ps">
        ...
        <div class="ul_01 ul_wrap">
            ...
            ?>
                <li>
                    <a href="<?php echo G5_ADMIN_URL;?>/shop_admin/itemuseform.php?w=u&amp;is_id=<?php echo $row['is_id']; ?>" class="ps_link"><?php echo conv_subject($row['is_subject'],40); ?></a>
                    <?php echo $name; ?>
                </li>
            <?php
            }
        ...
        <div class="btn_list03 btn_list">
            <a href="<?php echo G5_ADMIN_URL;?>/shop_admin/itemuselist.php?sort1=is_confirm&amp;sort2=asc">사용후기 더보기</a>
        </div>
    </section>
</div>
