...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		...
		<td>
			<input type="text" name="wset[scut]" value="<?php echo ($wset['scut']);?>" size="3" class="frm_input"> 자 - 0 입력시 전체출력
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			<?php echo help('댓글에는 출력안되며, PHP date 함수의 날짜포맷 입력');?>
			<input type="text" name="wset[date]" value="<?php echo $wset['date']; ?>" class="frm_input" size="8"> 형태 ex) Y.m.d 또는 m.d 등
		</td>
	</tr>
	<tr>
