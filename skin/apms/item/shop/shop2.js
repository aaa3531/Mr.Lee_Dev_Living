...
$(function() {
    ...
    */
    ...
    $(document).on("click", "#it_sel_option li button", function() {
		var mode = $(this).text();
        var this_qty, max_qty = 9999, min_qty = 0;
...
function add_sel_option(type, id, option, price, stock)
{
	...
	opt += "<button type=\"button\" class=\"it_qty_plus btn btn-sm btn-lightgray\"><span class=\"sound_only2\">증가</span></button>";
    opt += "<button type=\"button\" class=\"it_qty_minus btn btn-sm btn-lightgray\"><span class=\"sound_only2\">감소</span></button></div></div></div>";
    opt += "<button type=\"button\" class=\"it_opt_del btn btn-sm btn-lightgray\"><span class=\"sound_only2\">삭제</span></button></div>";
	if(!type) {
		if(it_msg1) {
...
function price_calculate()
{
    ...
    var $el_prc = $("#item_option input.io_price");
    var $el_qty = $("#item_option input[name^=ct_qty]");
    var $el_type = $("#item_option input[name^=io_type]");
    ...
    $("#it_tot_price2").empty().html(number_format(String(total))+"원");
	make_sub_option();
}
