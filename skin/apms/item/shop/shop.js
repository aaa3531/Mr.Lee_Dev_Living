...
function add_sel_option(type, id, option, price, stock)
{
	...
	opt += "<button type=\"button\" class=\"it_qty_plus btn btn-sm btn-lightgray\"><span class=\"sound_only\">증가</span></button>";
    opt += "<button type=\"button\" class=\"it_qty_minus btn btn-sm btn-lightgray\"><span class=\"sound_only\">감소</span></button></div></div></div>";
    opt += "<button type=\"button\" class=\"it_opt_del btn btn-sm btn-lightgray\"><span class=\"sound_only\">삭제</span></button></div>";
	if(!type) {
		if(it_msg1) {
