...
?>
<div class="req-title-text"><span>상품문의<b><?php echo $list_cnt;?></b></span></div>
           ...
           <div class="div-title">
			...
			<div class="media-body">
				<div class="media-info text-muted">
					<span class="name"><?php echo $list[$i]['iq_name']; ?></span>
					<span class="sp"></span>
					<time datetime="<?php echo date('Y-m-d\TH:i:s+09:00', $list[$i]['iq_time']) ?>"><?php echo apms_date($list[$i]['iq_time'], 'orangered', 'before');?></time>
					<span class="sp"></span>
	...
	<div class="pull-right">
		<div class="btn-group">
			<button type="button" class="btn btn-<?php echo $btn2;?> btn-sm" onclick="apms_form('itemqa_form', '<?php echo $itemqa_form; ?>');">
				문의하기<span class="sound_only"> 새 창</span>
			</button>
