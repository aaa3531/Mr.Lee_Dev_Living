...
if($is_orderable) echo '<script src="'.$item_skin_url.'/shop2.js?v=5"></script>'.PHP_EOL;
...
.fur-6 .div-tab.tabs ul.nav-tabs{
	width:100%;
}
#item-tab.div-tab.tabs.trans-top ul.nav-tabs li a, #item-tab.div-tab.tabs.trans-top ul.nav-tabs li.active a{
...
#btn_option_p{display:none;}
@media (max-width: 768px){
	
	#btn_option_p{display:block;}
	...
	#item-tab .tab-content .fixed-item-info.chk_toggle{
...
$("#btn_option_p").click(function(){
	if($("#fixed-item-info").hasClass("chk_toggle")){
		$("#fixed-item-info").removeClass("chk_toggle");
		$("#btn_option").html("▲");
	}else{
		$("#fixed-item-info").addClass("chk_toggle");
		$("#btn_option").html("▼");
	}
});
});
            ...
            <div class="head-2">
                ...
                <ul>
                   ...
                   <?php } else {?>
                    ...
                    <?php } ?>
                     <li>
                    <div class="s">PARK'S DESIGN 단독 가격</div>
                    <div class="p">월 <?php echo display_price(get_price($it)); ?><input type="hidden" id="it_price" value="<?php echo get_price($it); ?>"></div>
                    </li>
                </ul>
                <?php } ?>
            </div>
									...
									<div class="row">
										...
										<div class="col-sm-5">
											<div class="input-group">
												...
												<button type="button" class="it_qty_plus btn btn-lightgray btn-sm"><span></span></button>
												...
												<button type="button" class="it_qty_minus btn btn-lightgray btn-sm"><span></span></button>
											</div>
										</div>
									</div>
									<?php if($it['pt_msg1']) { ?>
			...
			<?php } ?>
             <?php if ($is_orderable) { ?>
				<div style="text-align:center; padding:12px 0;">
					...
					<li><input type="submit" onclick="document.pressed=this.value;" value="렌탈구매" class="btn btn-<?php echo $btn2;?> btn-block"></li>			
					</ul>
				</div>
...
<script>
    $(document).ready(function(){
        $('#tab_1').click(function(e){
            e.preventDefault();
           var scrollP =$('#explain-s').offset().top;
            $('html, body').animate({
                scrollTop : scrollP
            },500);
        });
        $('#tab_2').click(function(e){
            e.preventDefault();
           var scrollP= $('#item-review').offset().top;
            $('html, body').animate({
                scrollTop : scrollP
            },500);
        });
        $('#tab_3').click(function(){
           var scrollP= $('#item-qa').offset().top;
            $('html, body').animate({
                scrollTop : scrollP
            },500);
        });
        $('#tab_4').click(function(){
           var scrollP= $('#item-cmt').offset().top;
            $('html, body').animate({
                scrollTop : scrollP
            },500);
        });
        $('#tab_5').click(function(){
           ...
           var scrollP =$('#item-info').offset().top;
        ...
        $('#tab_6').click(function(){
           var scrollP= $('#item-delivery').offset().top;
            $('html, body').animate({
                scrollTop : scrollP
            },500);
        });
  ...
  <div class="tabline">
   <div class="at-container tab-store">
	<ul class="nav nav-tabs nav-justified">
	    <li class="active"><a id="tab_1" href="#explain-s" data-toggle="tab"><b>상세정보</b></a></li>
		<li><a id="tab_2" href="#item-review" data-toggle="tab"><b>리뷰<?php echo $it_use_cnt;?></b></a></li>
		<li><a id="tab_3" href="#item-qa" data-toggle="tab"><b>상품문의<?php echo $it_qa_cnt;?></b></a></li>
		<?php if($is_comment) { // 댓글 ?>
			<li><a id="tab_4" href="#item-cmt" data-toggle="tab"><b>댓글<?php echo $it_comment_cnt;?></b></a></li>
		<?php } ?>
		<?php if($is_ii) { // 상품정보고시 ?>
			<li><a id="tab_5" href="#item-info" data-toggle="tab"><b>필수표기정보</b></a></li>
		<?php } ?>
		<li><a id="tab_6" href="#item-delivery" data-toggle="tab"><b>배송/환불</b></a></li>
	...
	<div class="tab-content" style="border:0px; padding:20px 0px;">
        <div class="tab-pane">
	    <div class="tab-pane-in explain-dp active" id="explain-s">
	...
	(
		...
		*/
		...
		?>
			<div class="div-title-wrap" style='margin-top:100px;'>
				<div class="div-title" style="line-height:30px;">
					<i class="fa fa-cubes fa-lg lightgray"></i> <b>비슷한 상품</b>
				</div>
		...
		?>
			...
			<div class="div-title-wrap" style='margin-top:100px;'>
				<div class="div-title" style="line-height:30px;">
					<i class="fa fa-cubes fa-lg lightgray"></i> <b>인기 상품</b>
				</div>
				<div class="div-sep-wrap">
					<div class="div-sep sep-bold"></div>
				</div>
		...
		<div class="fixed-item-info chk_toggle" id="fixed-item-info">
			<script>
			...
			$(document).ready(function(){				
				$(document).on("change","#it_op_1",function(){
					...
					if($("#it_op_2").length<1)sel_option_process(true);
				});
			...
			#it_op_added .row{
              ...
              <?php if ($is_orderable) { ?>
						...
						<p id="btn_option_p" style='cursor:pointer'>&nbsp; <b> 선택옵션</b> <span id="btn_option">▼</span></p>
