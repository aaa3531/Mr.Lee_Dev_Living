   ...
   <?php if($is_guest_order) { // 비회원 주문일 때 ?>
		...
		<section id="sod_frm_agree" style="margin-bottom:0px;">
			<div class="panel panel-default">
			    <div class="heading"><h3>개인정보처리방침안내</h3></div>
	...
	<section id="sod_frm_orderer" style="margin-bottom:0px;">
		<div class="panel panel-default">
		 <div class="heading"><h3>주문하시는 분</h3></div>
			<div class="panel-body">
				...
				<div class="form-group has-feedback">
					...
					<div class="col-sm-8">
						...
						<label id="oddr3" class="sound_only" for="od_addr3">참고항목</label>
						<input id="oddr3" type="text" name="od_addr3" value="<?php echo get_text($member['mb_addr3']) ?>" id="od_addr3" class="form-control input-sm" size="50" readonly="readonly" placeholder="참고항목">
						<input id="oddr3" type="hidden" name="od_addr_jibeon" value="<?php echo get_text($member['mb_addr_jibeon']) ?>">
					</div>
				</div>
	...
	<section id="sod_frm_taker">
		<div class="panel panel-default">
		<div class="heading"><h3>받으시는 분</h3></div>
			<div class="panel-body">
			...
			<div class="panel-body">
				...
				<div class="form-group has-feedback">
					...
					<div class="col-sm-8">
						...
						<label>
		                    <button type="button" class="btn btn-black btn-sm" style="margin-top:0px;" onclick="win_zip('forderform', 'od_zip', 'od_addr1', 'od_addr2', 'od_addr3', 'od_addr_jibeon');">우편번호 찾기</button>
						</label>
                 ...
                 <div class="form-group has-feedback">
					<label class="col-sm-2 control-label" for="od_tel"><b>일반전화</b></label>
					<div class="col-sm-3">
						<input type="text" name="od_tel" value="<?php echo get_text($member['mb_tel']); ?>" id="od_tel" class="form-control input-sm" maxlength="20">
						<span class="fa fa-phone form-control-feedback"></span>
					</div>
				</div>
				<div class="form-group has-feedback">
					<label class="col-sm-2 control-label" for="od_hp"><b>휴대전화</b><strong class="sound_only">필수</strong></label>
					<div class="col-sm-3">
						<input type="text" name="od_hp" value="<?php echo get_text($member['mb_hp']); ?>" id="od_hp" required class="form-control input-sm" maxlength="20">
						<span class="fa fa-mobile form-control-feedback"></span>
					</div>
				</div>
				<div class="form-group has-feedback">
					...
					<div class="col-sm-5">
						<input type="text" name="od_email" value="<?php echo $member['mb_email']; ?>" id="od_email" required class="form-control input-sm email" size="35" maxlength="100">
						<span class="fa fa-envelope form-control-feedback"></span>
						<p>기재하신 메일주소로 주문내역과 결제내역을 보내드립니다.</p>
					</div>
			...
			<div class="panel-body">
				...
				<div class="form-group has-feedback">
					...
					<div class="col-sm-8">
						...
						<label>
							<button type="button" class="btn btn-black btn-sm" style="margin-top:0px;" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'od_b_addr3', 'od_b_addr_jibeon');">우편번호 찾기</button>
						</label>
						...
						<label id="oddr3" class="sound_only" for="od_b_addr3">참고항목</label>
						<input id="oddr3" type="text" name="od_b_addr3" id="od_b_addr3" class="form-control input-sm" size="50" readonly="readonly" placeholder="참고항목">
						<input id="oddr3" type="hidden" name="od_b_addr_jibeon" value="">
					</div>
				</div>
                <div class="form-group has-feedback">
					<label class="col-sm-2 control-label" for="od_b_tel"><b>일반전화</b></label>
					<div class="col-sm-3">
						<input type="text" name="od_b_tel" id="od_b_tel" class="form-control input-sm" maxlength="20">
						<span class="fa fa-phone form-control-feedback"></span>
					</div>
				</div>
				<div class="form-group has-feedback">
					<label class="col-sm-2 control-label" for="od_b_hp"><b>휴대전화</b><strong class="sound_only">필수</strong></label>
					<div class="col-sm-3">
						<input type="text" name="od_b_hp" id="od_b_hp" required class="form-control input-sm" maxlength="20">
						<span class="fa fa-mobile form-control-feedback"></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label" for="od_memo"><b>배송메시지</b></label>
					<div class="col-sm-8">
						<textarea name="od_memo" rows=3 id="od_memo" class="form-control input-sm"></textarea>
						<p>안전한 배송처 혹은 직접수령이 아닌경우 택배분실이 발생할 수 있으며, 이에대한 문의는 택배사에 확인해주세요 :)</p>
					</div>					
				</div>
