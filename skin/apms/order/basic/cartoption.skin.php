						...
						<div class="row">
							...
							<div class="col-sm-5">
								<div class="input-group">
									...
									<button type="button" class="it_qty_minus btn btn-black btn-sm"><span class="sound_only">감소</span></button>
									...
									<button type="button" class="it_qty_plus btn btn-black btn-sm"><span class="sound_only">증가</span></button>
								</div>
							</div>
						</div>
						<?php if($it['pt_msg1']) { ?>
