...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		...
		<td>
			...
			&nbsp;
			<label><input type="checkbox" name="wset[tabline]" value="1"<?php echo get_checked('1', $wset['tabline']);?>> 일반탭 상단라인 출력</label>
			-
			탭/버튼컬러
			<select name="wset[mctab]">
				<?php echo apms_color_options($wset['mctab']);?>
			</select>
		</td>
	</tr>
	<tr>
		<td>
			<label><input type="radio" name="wset[ctype]" value=""<?php echo get_checked('', $wset['ctype']);?>> 일반형</label>
			&nbsp;
			<label><input type="radio" name="wset[ctype]" value="1"<?php echo get_checked('1', $wset['ctype']);?>> 배분형</label>
			&nbsp;
			<label><input type="radio" name="wset[ctype]" value="2"<?php echo get_checked('2', $wset['ctype']);?>> 분할형</label>
			-
	...
	<tr>
		...
		<td>
			...
			&nbsp;
			정렬버튼
			<select name="wset[btn3]">
				<option value="">기본컬러</option>
				<?php echo apms_color_options($wset['btn3']);?>
			</select>
		</td>
	</tr>
	<tr>
