...
<div class="filter">
        <ul>
            ...
            <li>
            <?php if($ca_id == 10) { ?>
            <a <?php echo ($type == 1) ? 'class="on" ' : '';?> href="<?php echo G5_SHOP_URL; ?>/listtype.php?ca_id=10&type=1">퍼닝랭킹순</a>
            <?php } else if($ca_id == 20){ ?>
            <a <?php echo ($type == 1) ? 'class="on" ' : '';?> href="<?php echo G5_SHOP_URL; ?>/listtype.php?ca_id=20&type=2">퍼닝랭킹순</a>
            <?php } ?>
            </li>
        </ul>
</div>
