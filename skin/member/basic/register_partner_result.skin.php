...
<div class="panel panel-default">
	<div class="panel-heading"><h4><strong><i class="fa fa-birthday-cake fa-lg"></i> <strong><?php echo $mb['mb_name'] ?></strong>님의 파트너 회원가입을 진심으로 축하합니다.</strong></h4></div>
	<div class="panel-body">
		...
		<p>아래 하단의 파트너 정보등록을 하셔야만 파트너 메뉴이용이 가능하십니다. 이페이지를 벗어나도 상단메뉴에서 파트너 정보등록을 하실 수 있습니다.</p>
		<p>감사합니다.</p>
	</div>
</div>
...
<?php if(!$pim) { ?>
	<div class="text-center" style="margin:30px 0px;">
	    <a href="<?php echo G5_URL; ?>" class="btn btn-color" role="button">메인화면으로</a>
		<a href="<?php echo G5_URL; ?>/shop/partner/register.php" class="btn btn-color" role="button">파트너 정보등록</a>
	</div>
<?php } ?>