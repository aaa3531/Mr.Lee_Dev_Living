...
$g5['title'] = $member['mb_nick'].'님의 게시글';
    ...
    <div class="content-wrap">
       <div class="at-container">
        <div class="mypage-menu">
            ...
            <ul>
              <h4>나의 활동</h4>
               <li class="on"><a href="<?php echo $at_href['mypost'];?>">게시글/상품후기</a></li>
...
<div class="btn-group btn-group-justified">
	...
	<?php if(IS_YC) { ?>
	<a href="./mypost.php?mode=3" class="btn btn-sm btn-black<?php echo ($mode == "3") ? ' active' : '';?>">상품 댓글</a>
	<a href="./mypost.php?mode=4" class="btn btn-sm btn-black<?php echo ($mode == "4") ? ' active' : '';?>">상품 후기</a>
	<a href="./mypost.php?mode=5" class="btn btn-sm btn-black<?php echo ($mode == "5") ? ' active' : '';?>">상품 문의</a>
	<?php } ?>
</div>
