...
<form class="form-box form-horizontal register-form" role="form" id="fregisterform" name="fregisterform" action="<?php echo $action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
	...
	<div class="panel-join-member">
		<div class="panel-body">
            ...
            <hr>
            <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="input-join" size="10" placeholder="이름입력">
	...
	<div class="join-button-gr">
		<button type="submit" id="btn_submit" class="join-button" accesskey="s"><?php echo $w==''?'회원가입':'정보수정'; ?></button>
		<?php if(!$pim) { ?>
			<a href="<?php echo G5_URL ?>" class="join-button" role="button">취소</a>
		<?php } ?>
	</div>
