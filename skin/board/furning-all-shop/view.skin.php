...
<div class="board-content-view all-shop">
   ...
   <?php if ($is_tag) { // 태그 ?>
    ...
    <div class="view-info">
        ...
        <div class="cate-1">
            <ul>
                <li class="t">평수</li>
                <li class="c"><?php echo $view['wr_3']?></li>
            </ul>
            <ul>
                <li class="t">예산</li>
                <li class="c"><?php echo $view['wr_4']?></li>
            </ul>
            <ul>
                <li class="t">업종</li>
                <li class="c"><?php echo $view['wr_7']?></li>
            </ul>
            <ul>
                <li class="t">분위기</li>
                <li class="c"><?php echo $view['wr_6']?></li>
            </ul>
            <ul>
                <li class="t">컬러</li>
                <li class="c"><?php echo $view['wr_5']?></li>
            </ul>
        </div>
        <p>공유하기</p>
