...
<script>
    $(document).ready(function(){
        ...
        var sub_gall_1 = $('#sub-1');
        var sub_gall_2 = $('#sub-2');
        gall_1.click(function(){
            sub_gall_1.toggleClass('on');
            gall_1.toggleClass('on');
            gall_2.removeClass('on');
            sub_gall_2.removeClass('on');
        });
         gall_2.click(function(){
            sub_gall_2.toggleClass('on');
            gall_2.toggleClass('on');
            gall_1.removeClass('on');
            sub_gall_1.removeClass('on');
        });
    }); 
</script>
<div class="fur-1">
<div class="at-container">
<div class="fur-content-list tomo-best">
    <h3>BEST</h3>
    <p>베스트</p>
...
<section class="fur-content-list board-list<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>">
     <h3>SHOP</h3>
     <p>가게들</p>
	<style>
   ...
   <ul>
    ...
    <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sop=and&sst=wr_datetime&sod=desc">최신순</a></li>
    <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sop=and&sst=wr_good&sod=desc">인기순</a></li>
    <li id="gall-1">업종별</li>
    <li id="gall-2">컬러별</li>
    </ul>
    </div>
   <div class="filter-add">
       <ul id="sub-1">
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=카페-레스토랑">카페-레스토랑</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=오피스-관공서">오피스-관공서</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=음식점-주방">음식점-주방</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=펜션-리조트">펜션-리조트</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=로비-휴게실">로비-휴게실</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=호텔-웨딩홀">호텔-웨딩홀</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=병원-의원">병원-의원</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=학교-학원">학교-학원</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=바-호프">바-호프</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_1&stx=기타">기타</a></li>
        </ul>
        <ul id="sub-2">
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=블랙">블랙</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=화이트">화이트</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=레드">레드</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=블루">블루</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=그린">그린</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=오렌지">오렌지</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=옐로우">옐로우</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=퍼플">퍼플</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=핑크">핑크</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=그레이">그레이</a></li>
            <li><a href="<?php echo G5_URL; ?>/bbs/board.php?bo_table=tomorrow&sfl=wr_2&stx=기타">기타</a></li>
        </ul>
   </div>
    <ul>
        <?php 
        ...
        <li>
           ...
           <h4><?php echo $list[$i]['subject'];?></h4>
               <p><b><?php echo $list[$i]['name'];?></b> | <span>좋아요 <?php echo $list[$i]['wr_good'] ?></span> | <span>조회수 <?php echo $list[$i]['wr_hit'] //조회수 ?></span></p>
           </a>
        </li>
        <?php $k++; } ?>
    </ul>
...
<!--							<?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn btn-color btn-sm"><i class="fa fa-pencil"></i><span>글쓰기</span></a><?php } ?>-->
       ...
       <?php if($total_count > 0) { ?>
        ...
        <div class="modal-body">
                        ...
                        <a href="<?php echo $write_href ?>" class="btn btn-color btn-sm"><span>글쓰기</span></a><?php }else {?>
