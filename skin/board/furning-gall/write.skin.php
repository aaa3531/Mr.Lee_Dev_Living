...
<div id="bo_w" class="write-wrap<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>">
	...
	<?php } ?>
      <div class="form-group">
			<label class="col-sm-2 control-label" for="wr_1">분류 선택 - 업종별</label>
			<div class="col-sm-6">
				<select name="wr_1" required id="wr_1">
				    <option value="" selected>선택하세요</option>
				    <?php $arr = array("카페-레스토랑","오피스-관공서","음식점-주방","펜션-리조트","로비-휴게실","호텔-웨딩홀","병원-의원","학교-학원","바-호프","기타");
                    foreach ($arr as $v){
                        $selected = $write['wr_1'] == $v ? "selected" : "";
		...
		<div class="form-group">
			<label class="col-sm-2 control-label" for="wr_2">분류 선택 - 컬러별</label>
			<div class="col-sm-6">
				<select name="wr_2" required id="wr_2">
				    <option value="" selected>선택하세요</option>
				    <?php $arr = array("블랙","화이트","레드","블루","그린","오렌지","옐로우","퍼플","핑크","그레이","기타");
                    foreach ($arr as $v){
                        $selected = $write['wr_2'] == $v ? "selected" : "";
                        echo "<option value='".$v."'".$selected.">".$v."</option>";
