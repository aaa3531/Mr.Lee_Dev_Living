...
<div class="fur-1">
    <div class="at-container">
        <div class="fur-content-list">
            <h3>TOP 6</h3>
            <?php echo apms_widget('fur-board-content', $wid.'-fc25'); ?>
        </div>
    </div>
</div>
<div class="fur-2 list-board">
<div class="at-container">
<section class="board-list<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?> fur-board"> 
						...
						<form name="fsearch" method="get" role="form" class="form" style="margin-top:20px;">
							...
							<div class="form-group-2">
								...
								<select name="sfl" id="sfl" class="form-control input-sm">
								    ...
								    <option value="wr_1,0"<?php echo get_selected($sfl, 'wr_1,0'); ?>>키워드</option>
