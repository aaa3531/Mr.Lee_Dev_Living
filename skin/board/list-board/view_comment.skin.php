		...
		<div class="print-hide panel panel-default" style="margin-top:10px;">
			<div class="panel-body" style="padding-bottom:0px;">
					...
					<div class="row">
						<div class="col-xs-6">
							<div class="form-group has-feedback">
								...
								<input type="text" name="wr_name" value="<?php echo get_cookie("ck_sns_name"); ?>" id="wr_name" required class="form-control input-sm" size="5" placeholder="이름을 입력해주세요" maxLength="20">
						...
						<div class="col-xs-6">
							<div class="form-group has-feedback">
								...
								<input type="password" name="wr_password" id="wr_password" placeholder="비밀번호를 입력해주세요" required class="form-control input-sm" size="10" maxLength="20">
								<span class="fa fa-check form-control-feedback"></span>
							</div>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<textarea id="wr_content" placeholder="댓글 내용을 입력해주세요." name="wr_content" maxlength="10000" rows=5 required class="form-control input-sm" title="내용"
