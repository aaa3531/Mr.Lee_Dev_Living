...
//		}
   ...
   <?php if ($is_tag) { // 태그 ?>
    ...
    <?php if($view[wr_2] != '1') { ?> 
	<div class="jisik_info">
	  
		<?php if($is_member){ 
        echo "<B>{$member[mb_nick]}</B> 님의 지식을 나누어 주세요!<br>"; ?>
    ...
    <div class="view-info">
        ...
        <div class="cate-1">
            ...
            <ul>
                <li class="t">포인트</li>
                <li class="c"><?php echo number_format($view['wr_1'] + $board[bo_comment_point]); ?></li>
