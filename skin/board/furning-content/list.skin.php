        ...
        <li>
          <?php } ?>
           ...
           <h4><?php echo $list[$i]['subject'];?></h4>
               ...
               <!---<p><b><?php echo $list[$i]['name'];?></b> | <span> 좋아요 <?php echo $list[$i]['wr_good'] ?></span> | <span>구경 <?php echo $list[$i]['wr_hit'] //조회수 ?></span></p> -->
           </a>
        ...
        <div class="modal-body">
						<form name="fsearch" method="get" role="form" class="form" style="margin-top:20px;">
							...
							<div class="form-group-3" style="width:60%;">
								...
								<input type="text" name="stx" value="<?php echo stripslashes($stx) ?>" required id="stx" class="form-control input-sm" maxlength="20" placeholder="검색어를 입력해주세요." autocomplete="off">
