...
-->
    ...
    <div class="form-group">
			<label class="col-sm-2 control-label" for="wr_2">간단설명</label>
			<div class="col-sm-10">
                <input type="text" name="wr_2" value="<?php echo $write['wr_2']; ?>" id="wr_2" class="frm_input" size="20">
			</div>
    </div>
    <div class="form-group">
			<label class="col-sm-2 control-label" for="wr_5">유튜브 채널 명</label>
			<div class="col-sm-10">
                <input type="text" name="wr_5" value="<?php echo $write['wr_5']; ?>" id="wr_5" class="frm_input" size="20">
			</div>
    </div>
     <div id="wr_1_1" class="form-group">
			<label class="col-sm-2 control-label" for="wr_1">등록날짜</label>
			<div class="col-sm-3">
                <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input required" size="20">
			</div>
    </div>
...
<script>
$(document).ready(function(){
    $("#wr_1").datepicker({ changeMonth: true, changeYear: true, dateFormat: "yy-mm-dd", showButtonPanel: true, yearRange: "c-99:c+99", maxDate: "+730d" });
});
</script>