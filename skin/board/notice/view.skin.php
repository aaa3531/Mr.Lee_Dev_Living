...
<p class="event-sub">이벤트</p>
<div class="board-content-view">
    
    <div class="view-conte event">
...
//		}
	...
	<div class="view-content event">
     ...
     <h5>이벤트 기간 | <?php echo  $view['wr_1'] ?> ~ <?php echo  $view['wr_2'] ?></h5>
     <a href="<?php echo $list_href ?>" class="btn btn-black btn-sm evnet-button">
<!--				<i class="fa fa-bars"></i>--><span class="hidden-xs"> 이벤트 리스트 보기</span>
			</a>
	<?php
		// 이미지 하단 출력
...
-->
   ...
   <!--- <div class="view-info">
        ...
        <div class="cate-1">
            <ul>
                <li class="t">상태</li>
                <li class="c"><?php echo $view['ca_name']?></li>
            </ul>
            <ul>
                <li class="t">기간</li>
                <li class="c"><?php echo  $view['wr_1'] ?> ~ <br><?php echo  $view['wr_2'] ?></li>
            </ul>
        </div>
        <p>공유하기</p>
