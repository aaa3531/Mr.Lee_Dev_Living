...
<div class="fur-4 event">
<div class="at-container">
<h3 class="notice-tit">EVENT</h3>
<p class="notice-sub">이벤트</p>
<section class="board-list<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>"> 
	...
	<div class="list-wrap">
		<form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" role="form" class="form">
			...
			<div class="list-container event-inner">
			<ul>
			 <?php 
				$k = 0;
				for ($i=0; $i < $list_cnt; $i++) { 
					...
					$img = apms_wr_thumbnail($bo_table, $list[$i], 470, 230, false, true);
			...
			?>
				...
				<li class="list-row">
                  <a href="<?php echo $list[$i]['href'];?>">
				    ...
				    <h5><?php if($list[$i]['ca_name'] == '마감'){ ?>
                        <span class="v"><?php echo $list[$i]['ca_name'];?></span>
                   <?php } else {?>   
                        <span><?php echo $list[$i]['ca_name'];?></span>
                    <?php } ?> |&nbsp;&nbsp; <?php echo $list[$i]['wr_1'] ?> ~ <?php echo $list[$i]['wr_2'] ?></h5>
				</li>
			<?php $k++; } ?>
             </ul>
            </div>
