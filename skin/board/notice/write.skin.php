...
<div id="bo_w" class="write-wrap<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>">
	...
	<?php } ?>
    <div class="form-group">
			<label class="col-sm-2 control-label" for="wr_1">기간<strong class="sound_only">필수</strong></label>
			<div class="col-sm-3">
                <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input required" size="20"> ~ 
                <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input required" size="20">
			</div>
		</div>
	<div class="form-group">
...
-->
    ...
    <div class="form-group">
			<label class="col-sm-2 control-label" for="wr_3">간단설명</label>
			<div class="col-sm-10">
				<input type="text" name="wr_3" id="wr_3" value="<?php echo $write['wr_3']; ?>" class="form-control input-sm" size="50">
			</div>
		</div>
	<div class="form-group">
