...
<?php echo display_banner('렌탈베스트', 'mainbanner.30.skin.php'); ?>
<div class="fur-4">
...
<div class="tab-container">
    <div id="tab-1" class="tab-cont">
        ...
        <?php echo apms_widget('main-rental-best-item-list', $wid.'-wm2101'.$wn, 'ca_id=30 frm_input=30 sort=qty'); ?>
    </div>
    <div id="tab-2" class="tab-cont">
       <p><?php echo date('y년 m월 d일');?>기준</p>
        <?php echo apms_widget('main-rental-best-item-list', $wid.'-wm2102'.$wn, 'ca_id=30 frm_input=30 sort=qty term=week'); ?>
    </div>
    <div id="tab-3" class="tab-cont">
       <p><?php echo date('y년 m월 d일');?>기준</p>
        <?php echo apms_widget('main-rental-best-item-list', $wid.'-wm2103'.$wn, 'ca_id=30 frm_input=30 sort=qty term=month'); ?>
    </div>
</div>
    </div>
</div>
