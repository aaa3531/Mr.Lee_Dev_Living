		...
		<footer class="at-footer">
			...
			<div class="at-infos">
				<div class="at-container">
				        <div class="copy">
				            <ul>
                                <li><p>PARKSDESIGN</p><p><b>DH LivingCare</b></p></li>
...
<!--				                <li><p>대표전화</p><p><b><?php echo $default['de_admin_company_tel']; ?></b></p></li>-->
                                ...
                                <li><p>통신판매업신고</p><p><b><?php echo $default['de_admin_tongsin_no']; ?></b></p></li>
...
<!--		        <p>민원담당자 연락처 : <?php echo $default['de_admin_info_name']; ?> (<?php echo $default['de_admin_company_tel']; ?>)</p>-->
		        <h6>Copyrights &copy; 2021. PARKSDESIGN All rights Reserved. 본 사이트는 개발사의 소속 클라이언트 사업주님의 프로젝트 일부로써, 본 사이트는 서비스영업용이 아닌 견본 샘플용임을 알려드립니다. 운영중이 아닌 홈페이지 샘플용입니다.</h6>
