...
<div class="index-img">
		...
		?>
         <li class="ver<?php echo $a; ?>">
              <h3><?php echo $img[$i]['subject'];?></h3>
            </li>
          <?php } ?>
          </ul>
           <?php // 이미지글
		for ($i=0; $i < $list_cnt; $i++) { 
          ...
          <div class="thumb thumb<?php echo $a; ?>">
              <a href="<?php echo $img[$i]['href'];?>">
              <img src="<?php echo $img[$i]['img']['src'];?>"></a>  
          </div>
          <?php } ?>
</div>     
<?php if(!$list_cnt) { ?>
