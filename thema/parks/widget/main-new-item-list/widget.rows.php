    ...
    <li>
       <a href="<?php echo $list[$i]['href'];?>">
           ...
           <div class="thumb">
            ...
            <h5><?php if($list[$i]['it_tel_inq']) { ?>Call<?php } else { ?><span><?php echo $cur_price;?></span><?php echo number_format($list[$i]['it_price']);?><?php } ?><?php if($dc_per) { ?><span class="dc"><?php echo $dc_per;?>% DC</span><?php } ?></h5>
