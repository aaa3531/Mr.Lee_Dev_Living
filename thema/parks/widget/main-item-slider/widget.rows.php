...
if($list_cnt) {
?> 
<ul class="store-item-li main slick-slider">
   <?php 
...
<!--           <span class="rank-index"><b>BEST</b><?php echo $rank;$rank++;?></span>-->
           <div class="thumb">
            ...
            <h5><?php if($list[$i]['it_tel_inq']) { ?>Call<?php } else { ?><?php echo number_format($list[$i]['it_price']);?> 원 <?php } ?><?php if($dc_per) { ?><span class="dc">| <?php echo $dc_per;?>%</span><?php } ?></h5>
