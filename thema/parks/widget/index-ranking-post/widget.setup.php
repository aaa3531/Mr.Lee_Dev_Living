...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<td rowspan="2" align="center">이미지글</td>
		<td>
			<select name="wset[irows]">
				<option value="6"<?php echo get_selected('6', $wset['irows']);?>>6개</option>
				<option value="5"<?php echo get_selected('5', $wset['irows']);?>>5개</option>
				<option value="4"<?php echo get_selected('4', $wset['irows']);?>>4개</option>
	...
	<tr>
		<td>
			...
			&nbsp;
			<label><input type="checkbox" name="wset[idate]" value="1"<?php echo get_checked('1', $wset['idate']); ?>> 날짜</label>
			&nbsp;
